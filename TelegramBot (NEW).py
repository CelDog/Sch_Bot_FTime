...
def Admin_active(message):
        ...
        item1 = types.InlineKeyboardButton("Magic Button", callback_data='Admin')
            
        markup.add(item1)
            
        bot.send_message(message.chat.id, 'Нажмите на эту кнопку', reply_markup=markup)
...
def Any(message):
    if message.chat.type == 'private':
        ...
        if message.text == '📚 Расписание уроков':
            ...
            bot.reply_to(message, 'Извините, меня не научили отвечать на такие сообщения.')
    ...
    try:
       ...
       if call.message:
            if call.data == '1-1':
                ...
                item2 = types.KeyboardButton("🆗 Пусть так и будет")
 
                markup.add(item1, item2)
 
                less1 = open('1-А.txt','rt')
                bot.send_message(call.message.chat.id, less1.read(), reply_markup=markup)
                bot.send_message(call.message.chat.id,'Что с этим делать?')

                
            elif call.data == 'Admin':
                
                markup = types.InlineKeyboardMarkup(row_width=3)
                item1 = types.InlineKeyboardButton("1", callback_data='Admin(1)')
                item2 = types.InlineKeyboardButton("2", callback_data='Admin(2)')
                item3 = types.InlineKeyboardButton("3", callback_data='Admin(3)')
                item4 = types.InlineKeyboardButton("4", callback_data='Admin(4)')
                item5 = types.InlineKeyboardButton("5", callback_data='Admin(5)')
                item6 = types.InlineKeyboardButton("6", callback_data='Admin(6)')
                item7 = types.InlineKeyboardButton("7", callback_data='Admin(7)')
                item8 = types.InlineKeyboardButton("8", callback_data='Admin(8)')
                item9 = types.InlineKeyboardButton("9", callback_data='Admin(9)')
                item10 = types.InlineKeyboardButton("0", callback_data='Admin(10)')

                markup.add(item1, item2, item3, item4, item5, item6, item7, item8, item9, item10)
                
                bot.send_message(call.message.chat.id, 'Введите пароль', reply_markup=markup)
            
            elif call.data == 'Admin(3)':

                markup = types.InlineKeyboardMarkup(row_width=3)
                item1 = types.InlineKeyboardButton("1", callback_data='Admin(1)')
                item2 = types.InlineKeyboardButton("2", callback_data='Admin(2)')
                item3 = types.InlineKeyboardButton("3", callback_data='Admin(32)')
                item4 = types.InlineKeyboardButton("4", callback_data='Admin(4)')
                item5 = types.InlineKeyboardButton("5", callback_data='Admin(5)')
                item6 = types.InlineKeyboardButton("6", callback_data='Admin(6)')
                item7 = types.InlineKeyboardButton("7", callback_data='Admin(7)')
                item8 = types.InlineKeyboardButton("8", callback_data='Admin(38)')
                item9 = types.InlineKeyboardButton("9", callback_data='Admin(9)')
                item10 = types.InlineKeyboardButton("0", callback_data='Admin(10)')
            ...
            elif call.data == 'Admin(38)':

                markup = types.InlineKeyboardMarkup(row_width=3)
                item1 = types.InlineKeyboardButton("1", callback_data='Admin(1)')
                item2 = types.InlineKeyboardButton("2", callback_data='Admin(2)')
                item3 = types.InlineKeyboardButton("3", callback_data='Admin(383)')
                item4 = types.InlineKeyboardButton("4", callback_data='Admin(4)')
                item5 = types.InlineKeyboardButton("5", callback_data='Admin(5)')
                item6 = types.InlineKeyboardButton("6", callback_data='Admin(6)')
                item7 = types.InlineKeyboardButton("7", callback_data='Admin(7)')
              ...
              item20 = types.InlineKeyboardButton("10-Б", callback_data='10-Б(W)')
              item21 = types.InlineKeyboardButton("11-А", callback_data='11-А(w)')
              item22 = types.InlineKeyboardButton("11-Б", callback_data='11-Б(w)')

              markup.add(item1, item2, item3, item4, item5, item6, item7, item8, item9, item10, item11, item12, item13, item14, item15, item16, item17, item18, item19, item20, item21, item22)
         
              bot.send_message(call.message.chat.id, 'Вы - Админ! Это значит, что вы теперь можете отредактировать расписание уроков.')   
              bot.send_message(call.message.chat.id, "Выберите класс, расписание которого вы хотите изменить", reply_markup=markup)
